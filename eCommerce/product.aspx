...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="productUpperPart">
        ...
        <div class="productInfo">
            ...
            <asp:Button ID="btnBuy" CssClass="buyButton" runat="server" Text="Add To Cart" 
                OnClick="btnBuy_Click" CausesValidation="False" />
              <asp:Button ID="btnwish" CssClass="buyButton" runat="server" Text="Add To Wish List" 
                OnClick="btnwish_Click" CausesValidation="False" />
        </div>
    </div>
